...
export const AUTO_CALCULATORS: CalculatorDefinition[] = [
  {
    ...
    inputs: [
      { id: 'distance', label: 'Fahrstrecke in Kilometern (einfach)', type: 'number', defaultValue: 50, min: 1, step: 1, unit: 'km' },
      ...
      { id: 'tripsCount', label: 'Anzahl der Fahrten', type: 'number', defaultValue: 1, min: 1, step: 1, helpText: '1 = Einzelfahrt, 2 = Hin- und Rückfahrt' },
    ],
    ...
    content: {
      intro: 'Egal ob für den Urlaub, die Bildung von Fahrgemeinschaften oder den täglichen Weg zur Arbeit: Unser Spritkostenrechner ermittelt die reinen Kraftstoffausgaben auf den Cent genau.',
      details: 'Zusätzlich sehen Sie die Kosten pro gefahrenem Kilometer sowie Hochrechnungen für monatliches und jährliches Pendeln.',
      tips: [
        'Tragen Sie für Fahrgemeinschaften die Gesamtkosten ein und teilen Sie den Betrag fair durch die Anzahl der Mitfahrer.',
        'Vorausschauendes Fahren und korrekter Reifendruck senken den Verbrauch um bis zu 15 %.',
      ],
    },
    faqs: [
      { question: 'Wie teile ich Spritkosten bei einer Fahrgemeinschaft auf?', answer: 'Geben Sie die gesamte Hin- und Rückfahrt ein (Anzahl Fahrten = 2). Teilen Sie den berechneten Gesamtwert einfach durch die Anzahl der mitfahrenden Personen.' },
      { question: 'Sind in den Spritkosten auch Verschleiß und Versicherung enthalten?', answer: 'Nein, dieser Rechner ermittelt die reinen Kraftstoffkosten. Für Vollkosten inklusive Wertverlust und Versicherung nutzen Sie unseren Kilometerkosten-Rechner.' },
    ],
    relatedSlugs: ['fahrtkostenrechner', 'pendlerpauschale-rechner', 'kraftstoffverbrauch-rechner', 'elektroauto-ladekosten-rechner'],
  },
  {
    ...
    content: {
      intro: 'Bordcomputer zeigen oft geschönte Werte an. Mit der klassischen Zapfsäulen-Methode (voll tanken, Tageskilometerzähler auf 0, beim nächsten Volltanken Werte notieren) ermitteln Sie den echten Verbrauch.',
      details: 'Tragen Sie die Werte einfach ein, um den tatsächlichen Durst Ihres Fahrzeugs zu überprüfen.',
    },
    faqs: [
      { question: 'Wie messe ich den Verbrauch am genauesten?', answer: 'Tanken Sie den Wagen an derselben Zapfsäule voll bis zum automatischen Abschalten der Zapfpistole. Fahren Sie den Tank leer und tanken Sie wieder bis zum ersten Klick nach.' },
    ],
    relatedSlugs: ['spritkostenrechner', 'fahrtkostenrechner', 'co2-auto-rechner'],
  },
  {
    ...
    inputs: [
      ...
      { id: 'workdays', label: 'Tatsächliche Arbeitstage im Jahr', type: 'number', defaultValue: 220, min: 1, max: 365, step: 1, unit: 'Tage' },
    ],
    ...
    content: {
      intro: 'Die Pendlerpauschale ist einer der lukrativsten Steuerabzüge für deutsche Arbeitnehmer. Sie gilt verkehrsmittelunabhängig – egal ob Sie mit dem Auto, dem Zug, dem Fahrrad oder zu Fuß zur Arbeit gelangen.',
      details: 'Gültig ist stets die kürzeste verkehrsübliche Straßenverbindung zwischen Wohnung und erster Tätigkeitsstätte.',
      tips: [
        'Liegen Ihre gesamten Werbungskosten über dem Arbeitnehmer-Pauschbetrag (1.230 €), mindert jeder weitere Euro direkt Ihr zu versteuerndes Einkommen.',
        'Bei Nutzung öffentlicher Verkehrsmittel können Sie anstelle der Pauschale die tatsächlichen Ticketkosten ansetzen, wenn diese höher sind.',
      ],
    },
    faqs: [
      { question: 'Gilt die Pendlerpauschale auch für Hin- und Rückweg?', answer: 'Nein, die Entfernungspauschale wird ausschließlich für die einfache Wegstrecke (Luftlinie auf der Straße) gewährt, nicht für Hin- und Rückfahrt zusammen.' },
      { question: 'Darf ich die Pauschale ansetzen, wenn ich im Homeoffice arbeite?', answer: 'Nein. Für Tage im Homeoffice gilt die Homeoffice-Pauschale (6 € pro Tag, maximal 1.260 € im Jahr). An denselben Tagen kann keine Pendlerpauschale geltend gemacht werden.' },
    ],
    relatedSlugs: ['spritkostenrechner', 'fahrtkostenrechner', 'arbeitstage-rechner'],
  ...
  },
  {
    ...
    metaTitle: 'Fahrtkostenrechner – Gesamte Autokosten einer Reise kalkulieren',
    ...
    shortDescription: 'Ermittelt die Gesamtkosten von Autofahrten inklusive Nebenkosten und Mitfahreraufteilung.',
    ...
    content: {
      intro: 'Planen Sie einen gemeinsamen Ausflug oder eine Urlaubsfahrt im Auto? Berechnen Sie vorab transparent, wie viel Kraftstoff benötigt wird und wie viel jeder Mitfahrer beisteuern sollte.',
      details: 'Geben Sie einfach die Fahrdaten ein und verteilen Sie die Last fair.',
    },
    faqs: [
      { question: 'Darf ich bei Mitfahrgelegenheiten Geld verlangen?', answer: 'Ja, die anteilige Kostenbeteiligung an den reinen Fahrtkosten (Sprit, Maut) ist privat zulässig und steuerlich unbedenklich, solange keine gewerbliche Gewinnerzielungsabsicht vorliegt.' },
    ],
    relatedSlugs: ['spritkostenrechner', 'fahrzeit-rechner', 'pendlerpauschale-rechner'],
  },
  {
    ...
    metaTitle: 'Elektroauto Ladekosten Rechner – Stromkosten pro 100 km & Ladung',
    ...
    content: {
      intro: 'Wie viel kostet das Fahren mit dem Elektroauto im Vergleich zu Benzin oder Diesel? Mit diesem Rechner ermitteln Sie die genauen Stromkosten für den Heimtarif oder öffentliche Ladesäulen.',
      details: 'Bei einem Haushaltsstrompreis von rund 0,38 €/kWh fahren viele Elektroautos im Alltag deutlich günstiger als moderne Verbrenner.',
    },
    faqs: [
      { question: 'Gibt es Ladeverluste beim Laden von Elektroautos?', answer: 'Ja, beim Laden über Wechselstrom (AC) an der Steckdose oder Wallbox entstehen Umwandlungs- und Leitungsverluste von typischerweise 5 % bis 15 %.' },
    ],
    relatedSlugs: ['spritkostenrechner', 'co2-auto-rechner', 'stromkostenrechner'],
    isTimeSensitive: true,
    timeSensitiveMeta: {
  ...
  },
  {
    ...
    content: {
      intro: 'Planen Sie Ihre Reise realistisch: Auf deutschen Autobahnen liegt die reale Durchschnittsgeschwindigkeit wegen Baustellen und Tempolimits selten über 100 bis 115 km/h.',
      details: 'Dieser Rechner kombiniert Fahrzeit und vorgeschriebene Erholungspausen für eine sichere Ankunft.',
    },
    faqs: [
      { question: 'Wie oft sollte man bei langen Autofahrten pausieren?', answer: 'Der ADAC und Verkehrssicherheitsverbände empfehlen, spätestens alle zwei Stunden eine mindestens 15- bis 20-minütige Bewegungspause einzulegen.' },
    ],
    relatedSlugs: ['spritkostenrechner', 'fahrtkostenrechner'],
  },
  {
    id: 'co2-auto-rechner',
    ...
    shortDescription: 'Berechnet Treibhausgasemissionen basierend auf Umweltbundesamt-Faktoren.',
    ...
    content: {
      intro: 'Klimaschutz beginnt mit Transparenz: Erfahren Sie, wie viele Tonnen CO2 Ihr Fahrzeug im Laufe eines Jahres ausstößt.',
      details: 'Die Berechnung basiert auf den wissenschaftlich anerkannten Faktoren des deutschen Umweltbundesamts.',
    },
    faqs: [
      { question: 'Warum stößt 1 Liter Benzin mehr als 2 kg CO2 aus?', answer: 'Weil sich bei der Verbrennung der Kohlenstoff (C) aus dem Kraftstoff mit dem Sauerstoff (O2) aus der Luft verbindet. Dadurch wiegt das entstehende CO2-Molekül deutlich mehr als der flüssige Kraftstoff allein.' },
    ],
