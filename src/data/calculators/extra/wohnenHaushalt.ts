...
export const EXTRA_WOHNEN_HAUSHALT: CalculatorDefinition[] = [
  // ==================== FINANZEN (1 ZUSÄTZLICHER ZUR KOMPLETTIERUNG AUF 25) ====================
  {
    ...
    relatedSlugs: ['teilzeit-gehaltsrechner', 'kapitalertragsteuer-rechner', 'kapitalertragsteuer-rechner'],
  ...
  // ==================== WOHNEN & IMMOBILIEN (20 ZUSÄTZLICHE) ====================
  {
    ...
    relatedSlugs: ['mietbelastungsquote-rechner', 'mietkaution-zinsen-rechner', 'mietrendite-brutto-netto-rechner'],
  },

  {
    ...
    relatedSlugs: ['indexmiete-rechner', 'mietbelastungsquote-rechner', 'mietbudget-rechner'],
  },

  {
    ...
    relatedSlugs: ['staffelmiete-rechner', 'mietbelastungsquote-rechner', 'inflationsrechner'],
  },
...

  {
    ...
    relatedSlugs: ['mietbelastungsquote-rechner', 'mietminderung-rechner', 'mietbudget-rechner'],
  },
...

  {
    ...
    relatedSlugs: ['mietbudget-rechner', 'abschreibung-immobilien-rechner', 'hausgeld-rechner'],
  },
...

  {
    ...
    relatedSlugs: ['mietbelastungsquote-rechner', 'mietminderung-rechner', 'stromkostenrechner'],
  },
  ...
  // ==================== HAUSHALT & ENERGIE (21 ZUSÄTZLICHE) ====================
  {
    ...
    relatedSlugs: ['stromkostenrechner', 'gasverbrauch-kwh-m3-rechner', 'led-sparrechner'],
    isTimeSensitive: true,
    timeSensitiveMeta: {
      year: 2026,
...

  {
    ...
    relatedSlugs: ['stromkosten-geraete-rechner', 'stromkostenrechner', 'balkonkraftwerk-ertrag-rechner'],
  },
