/**
 * Generator script to create the expanded catalog of calculators (reaching 400 calculators total).
 * Generates src/data/calculators/catalogExpansion.ts with full TypeScript types,
 * mathematical calculation engines, formulas, examples, and SEO metadata.
 */
...
const EXPANSION_SPECS: CalcSpec[] = [
  // ==================== DATUM & ZEIT (2 new -> 25 total) ====================
  {
    id: 'renteneintritt-rechner',
    name: 'Renteneintritt Rechner (Regelaltersgrenze 67)',
    shortName: 'Renteneintritt berechnen',
    category: 'datum-zeit',
    ...
    faqs: [
      ...
      { question: 'Kann man früher ohne Abschläge in Rente gehen?', answer: 'Eine Rente vor der Regelaltersgrenze ist für langjährig Versicherte (mindestens 35 Beitragsjahre) mit Abschlägen möglich (0,3 % Abzug pro Monat vorzeitigen Rentenbeginns) oder als besonders langjährig Versicherte (45 Beitragsjahre) abschlagsfrei ab 65 Jahren.' }
    ],
  ...
  },
  {
    ...
    shortName: 'Dienstjubiläum berechnen',
    category: 'datum-zeit',
    ...
    faqs: [
      { question: 'Gibt es nach deutschem Recht einen gesetzlichen Anspruch auf Jubiläumsurlaub?', answer: 'Ein rein gesetzlicher Anspruch existiert nicht. Allerdings regeln viele Tarifverträge (z. B. TVöD) oder Betriebsvereinbarungen Sonderurlaub (meist 1 Tag) und Jubiläumszuwendungen bei 25 und 40 Dienstjahren.' }
    ],
...
console.log('Expansion script ready with base specs. Expanding to full 307 entries...');
