...
const list = mod.EXTRA_GESUNDHEIT_FAMILIE;
console.log('Total calculators in EXTRA_GESUNDHEIT_FAMILIE:', list.length);
...
// Test every calculator's calculate function with default inputs!
let calcErrors = 0;
for (const c of list) {
  const defaultInputs = {};
