...
const file = 'src/data/calculators/extra/bauenGeometrie.ts';
...
const list = mod.EXTRA_BAUEN_GEOMETRIE;
console.log('Total calculators in EXTRA_BAUEN_GEOMETRIE:', list.length);
