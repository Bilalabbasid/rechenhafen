...
const targetFile = path.join(__dirname, '../../src/data/calculators/extra/autoArbeit.ts');

// Script to generate autoArbeit.ts
const code = `import { CalculatorDefinition } from '@/types/calculator';
...
export const EXTRA_AUTO_ARBEIT: CalculatorDefinition[] = [
...

  {
    ...
    relatedSlugs: ['dienstwagen-1-prozent-rechner', 'brutto-netto-rechner', 'pendlerpauschale-rechner'],
  },
...

  {
    ...
    name: 'Fahrgemeinschaft Rechner (Kostenaufteilung pro Mitfahrer)',
    shortName: 'Fahrgemeinschaft Rechner',
    category: 'auto-verkehr',
    subcategory: 'Fahrt & Navigation',
  ...
  // ==================== ARBEIT & GEHALT (21 ZUSÄTZLICHE) ====================
  {
    ...
    relatedSlugs: ['arbeitslosengeld-1-rechner', 'brutto-netto-rechner', 'teilzeit-gehaltsrechner'],
  },

  {
    ...
    relatedSlugs: ['kuendigungsfrist-arbeitnehmer-rechner', 'brutto-netto-rechner', 'urlaubsabgeltung-rechner'],
  },

  {
    ...
    relatedSlugs: ['teilzeit-gehaltsrechner', 'brutto-netto-rechner', 'arbeitgeberanteil-sozialversicherung-rechner'],
  },

  {
    ...
    relatedSlugs: ['brutto-netto-rechner', 'minijob-midijob-rechner', 'stundenlohnrechner'],
  },
...

  {
    ...
    name: 'Überstunden Auszahlung Rechner (Brutto / Netto & Zuschläge)',
    ...
    relatedSlugs: ['stundenlohnrechner', 'brutto-netto-rechner', 'teilzeit-gehaltsrechner'],
  },

  {
    id: 'firmenwagen-geldwerter-vorteil-rechner',
    slug: 'firmenwagen-geldwerter-vorteil-rechner',
    name: 'Firmenwagen Geldwerter Vorteil Rechner (Lohnabrechnung)',
...

  {
    ...
    relatedSlugs: ['arbeitslosengeld-1-rechner', 'brutto-netto-rechner', 'kurzarbeitergeld-rechner'],
  },

  {
    ...
    relatedSlugs: ['elternzeit-teilzeit-rechner', 'brutto-netto-rechner', 'urlaubstage-rechner'],
  },

  {
    ...
    relatedSlugs: ['teilzeit-gehaltsrechner', 'mutterschaftsgeld-rechner', 'brutto-netto-rechner'],
  },

  {
    ...
    relatedSlugs: ['urlaubstage-rechner', 'brutto-netto-rechner', 'teilzeit-gehaltsrechner'],
  },

  {
    ...
    relatedSlugs: ['stundenlohnrechner', 'ueberstunden-auszahlung-rechner', 'brutto-netto-rechner'],
  },

  {
    ...
    relatedSlugs: ['betriebliche-altersvorsorge-rechner', 'brutto-netto-rechner', 'sparplanrechner'],
  },

  {
    id: 'betriebliche-altersvorsorge-rechner',
    slug: 'betriebliche-altersvorsorge-rechner',
    name: 'Betriebliche Altersvorsorge Rechner (bAV & 15 % AG-Zuschuss)',
    ...
    relatedSlugs: ['vermoegenswirksame-leistungen-rechner', 'brutto-netto-rechner', 'renteneintritt-rechner'],
  },

  {
    ...
    relatedSlugs: ['stundenlohnrechner', 'brutto-netto-rechner', 'gehaltserhoehung-rechner'],
  },

  {
    ...
    relatedSlugs: ['stundenlohnrechner', 'brutto-netto-rechner', 'jahresgehalt-in-monatsgehalt-rechner'],
  },

  {
    id: 'urlaubsabgeltung-rechner',
    slug: 'urlaubsabgeltung-rechner',
    name: 'Urlaubsabgeltung Rechner (§ 11 BUrlG bei Kündigung)',
...

  {
    ...
    name: 'Arbeitslosengeld 1 Rechner (ALG I Anspruch nach SGB III)',
    ...
    relatedSlugs: ['buergergeld-anspruch-rechner', 'brutto-netto-rechner', 'kurzarbeitergeld-rechner'],
  },

  {
    ...
    relatedSlugs: ['arbeitslosengeld-1-rechner', 'warmmiete-zu-kaltmiete-rechner', 'brutto-netto-rechner'],
  },

  {
    ...
    relatedSlugs: ['brutto-netto-rechner', 'dienstfahrrad-jobrad-rechner', 'dienstaufwandsentschaedigung-rechner'],
  },

  {
    id: 'dienstaufwandsentschaedigung-rechner',
    slug: 'dienstaufwandsentschaedigung-rechner',
    name: 'Ehrenamtspauschale & Übungsleiterpauschale Rechner (§ 3 EStG)',
    ...
    relatedSlugs: ['minijob-midijob-rechner', 'brutto-netto-rechner', 'dienstjubilaeum-steuerfrei-rechner'],
  },
];
`;

fs.writeFileSync(targetFile, code, 'utf-8');
console.log('Successfully written extra autoArbeit.ts with 39 calculators!');
`;

fs.writeFileSync('scripts/generators/generate-auto-arbeit.js', code, 'utf-8');
console.log('Created generate-auto-arbeit.js');
