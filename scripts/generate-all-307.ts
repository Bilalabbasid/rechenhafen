/**
 * Master catalog expansion generator.
 * Builds exactly the 307 calculators required to reach 400 total calculators.
...
// We will accumulate specs
const ALL_EXPANDED_SPECS: Spec[] = [];

function addSpec(s: Spec) {
  ALL_EXPANDED_SPECS.push(s);
}

// ==================== 1. DATUM & ZEIT (2 specs) ====================
addSpec({
...
console.log(`Generated ${ALL_EXPANDED_SPECS.length} base specs so far.`);
